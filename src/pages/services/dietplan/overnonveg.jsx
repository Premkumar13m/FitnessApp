...
export default function overNonVeg() {
    const data = [
      {
        title: "DAY 1",
        plans: [
          ...
          },
          {
            ...
            food: "1 medium apple, sliced + 1 Tbsp. peanut butter",
          },
          {
            time: "Lunch (2:00-2:30PM)",
            food: "1 serving Veggie & Hummus Sandwich",
          },
          {
      ...
      },
      {
        ...
        plans: [
          ...
          {
            time: "Mid-Meal (11:00-11:30AM)",
            food: "1 oz. Cheddar cheese + 1 hard-boiled egg",
          },
          {
            time: "Lunch (2:00-2:30PM)",
      ...
      },
      {
        ...
        plans: [
          ...
          {
            time: "Dinner (8:00-8:30PM)",
            food: "1 serving Chicken & Cucumber Lettuce Wraps with Peanut Sauce",
          },
        ],
      },
      {
      ...
      },
      {
        ...
        plans: [
          {
            time: "Breakfast (8:00-8:30AM)",
            food: "1 serving Egg in a Hole Peppers with Avocado Salsa",
          },
          {
            time: "Mid-Meal (11:00-11:30AM)",
            food: "1 medium apple",
        ...
        <div className="container mx-auto px-10 bg-[#ff4a5f] text-white">
          <div className>
            <h1 className="font-inter font-[600] text-[28px] text-center">
              Weekly Diet Plan for Non-Vegetarians for Weight Loss
            </h1>
            {data.map((items, i) => (

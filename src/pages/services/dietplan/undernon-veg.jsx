...
export default function underNonVeg() {
    const data = [
      {
        title: "DAY 1",
        plans: [
          {
            ...
            food: "2 egg brown bread sandwich + green chutney + 1 cup milk + 3 cashews + 4 almonds + 2 walnuts",
          },
          {
          ...
          },
          {
            ...
            food: "1 cup arhar dal + 1 cup potato curry + 3 chapatti + 1/2 cup rice + 1/2 cup low fat curd + salad",
          },
          {
          ...
          },
          {
            ...
            food: "1.5 cup chicken curry + 3 chapatti + salad",
          },
        ],
      },
      {
        ...
        plans: [
          ...
          {
            time: "Lunch (2:00-2:30PM)",
            food: "1 cup moong dal/ chicken curry + 1 cup potato and caulifllower vegetable + 3 chapatti + 1/2 cup rice + salad",
          },
          {
            time: "Evening (4:00-4:30PM)",
      ...
      },
      {
        ...
        plans: [
          {
            time: "Breakfast (8:00-8:30AM)",
            food: "3 paneer stuffed besan cheela + green chutney + 1 cup curd + 3 cashews + 4 almonds + 2 walnuts",
          },
          {
            time: "Mid-Meal (11:00-11:30AM)",
      ...
      },
      {
        ...
        plans: [
          ...
          {
            time: "Lunch (2:00-2:30PM)",
            food: "1 cup white chana/ fish curry + 3 chapatti + 1/2 cup rice + salad",
          },
          {
            time: "Evening (4:00-4:30PM)",
    ...
    return (
      <section>
        <div className="container mx-auto px-10 bg-[#ff4a5f] opacity-50 text-white">
          <div className>
            <h1 className="font-inter font-[600] text-[28px] text-center">
              Weekly Diet Plan for Non-Vegetarians for Weight Gain
            </h1>
            {data.map((items, i) => (
